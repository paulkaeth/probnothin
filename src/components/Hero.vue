  ...
  <section class="relative text-slate-400">
    ...
    >
      <div class="hero text-center text-slate-100 font-black tracking-tight">
        ...
        <h2
          class="py-2 text-4xl mb-12 md:text-7xl lg:text-8xl lg:mb-24 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500"
        >
    ...
    <div class="absolute z-0 left-0 right-0 bottom-0 w-full">
      ...
      >
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M1678 0L2323.19 787.199H1920V798H0V787.834H-255.372L143 383.752L298.091 541.066L677 200.771L980.326 473.186L1229 259.223L1367.72 378.578L1678 0Z"
